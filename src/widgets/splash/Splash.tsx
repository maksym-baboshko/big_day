          ...
          >
            ...
            <div className="absolute inset-0 z-[5] pointer-events-none overflow-hidden">
              ...
              >
                ...
                <path d="M389 11 L392.5 14.5 L389 18 L385.5 14.5 Z" fill="#A8845A" opacity="0.6" />
                ...
                <path
                  ...
                  opacity="0.6"
                />
                <path d="M200 11 L202.5 13.5 L200 16 L197.5 13.5 Z" fill="#A8845A" opacity="0.4" />
                <path
            ...
            <motion.div
              ...
              transition={{ duration: 1, times: [0, 0.63, 0.8, 1], ease: "easeIn" }}
            >
              <svg
              ...
              >
                ...
                <circle cx="50" cy="50" r="36" stroke="rgba(255,245,200,0.35)" strokeWidth="0.8" />
